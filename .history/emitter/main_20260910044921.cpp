...
int main() {
    ...
    stream_video = new emitter("localhost", "5000", "/dev/video6"); // Ip de la máquina windows con el VR dentro del lab 192.168.8.112 // Creo que en el robot es video 4 o 6

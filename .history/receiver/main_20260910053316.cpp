...
bool emitter::Iniciar() {
    ...
    std::string pipeline_str = 
        ...
        "video/x-raw,format=YUY2,width=640,height=480,framerate=30/1 ! " // Negociación obligatoria
        "videoconvert ! "
        "x264enc tune=zerolatency speed-preset=ultrafast ! "             // Compresión por CPU al límite
        "rtph264pay pt=96 ! "                                            // Empaquetado de red UDP
